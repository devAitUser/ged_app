         ...
         <form action="{{route('user_profile_update')}}"  method="post">
            ...
            <table class="tbl_profil">
               <tr>
                  ...
                  <td> <input type="text" class="input_prof"  value="{{ $user['identifiant'] }}"  > </td>
               </tr>
               <tr>
               ...
               <tr>
                  ...
                  <td> <input type="text" class="input_prof" name="nom" value="{{ $user['nom'] }}" > </td>
               </tr>
               <tr>
                  <td class="td_1">Prénom   :</td>
                  <td> <input type="text" class="input_prof" name="prenom" value="{{ $user['prenom'] }}" > </td>
               </tr>
               <tr>
